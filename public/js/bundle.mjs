(function () {
  ...
  var app = {
    'css': `app > div,[is="app"] > div{ display:block; padding-top: 40px; }`,
    'exports': {},
    ...
    'template': function(template, expressionTypes, bindingTypes, getComponent) {
      return template('<router expr0="expr0"></router>', [{
        ...
        'slots': [{
          'id': 'default',
          'html': '<sf_navbar expr1="expr1"></sf_navbar><div><sf_title expr2="expr2"></sf_title><route expr3="expr3" path="/"></route><route expr5="expr5" path="/#login"></route><route expr7="expr7" path="/#about"></route><route expr9="expr9" path="/#signup"></route></div>',
          ...
          'bindings': [{
            ...
            'slots': [{
              'id': 'default',
              'html': '<sf_home expr4="expr4"></sf_home>',
            ...
            'slots': [{
              'id': 'default',
              'html': '<sf_login expr6="expr6"></sf_login>',
            ...
            'slots': [{
              'id': 'default',
              'html': '<sf_about expr8="expr8"></sf_about>',
            ...
            'slots': [{
              'id': 'default',
              'html': '<sf_signup expr10="expr10"></sf_signup>',
  ...
  var sf_button = {
    ...
    'template': function(template, expressionTypes, bindingTypes, getComponent) {
      return template('<button expr11="expr11"><slot expr12="expr12"></slot></button>', [{
        ...
        'expressions': [{
          ...
          'evaluate': function(scope) {
            return ['button ', scope.props.class].join('');
          }
        }]
      }, {
        ...
        [{
          ...
          'template': template(' ', [{
            'expressions': [{
              ...
              'evaluate': function(scope) {
                return ['lebel ', scope.props.labelClass].join('');
              }
            }]
          }])
        }, {
          ...
          'expressions': [{
            ...
            'evaluate': function(scope) {
              return ['input ', scope.props.class].join('');
            }
          }, {
            'type': expressionTypes.ATTRIBUTE,
            'name': 'type',
            ...
            'evaluate': function(scope) {
              return ['$', scope.props.type || "text"].join('');
            }
          }, {
            'type': expressionTypes.ATTRIBUTE,
            'name': 'placeholder',
          ...
          'template': template(' ', [{
            'expressions': [{
              ...
              'evaluate': function(scope) {
                return ['help ', scope.props.helpClass].join('');
              }
            }]
          }])
        }]
  ...
  var sf_login = {
    'css': `sf_login,[is="sf_login"]{ display:block; } sf_login > header,[is="sf_login"] > header{ background:gray; color:white; } sf_login .login,[is="sf_login"] .login{ max-width:300px; margin:auto; }`,
    'exports': null,
  ...
  var sf_about = {
    ...
    'template': function(template, expressionTypes, bindingTypes, getComponent) {
      return template('<h1>Profile</h1><p>Hi!! I am Satoshi Fujiwara. How do you do?</p>', []);
    },
  ...
  var sf_signup = {
    ...
    'template': function(template, expressionTypes, bindingTypes, getComponent) {
      return template('<div><h1>サインアップ</h1></div>', []);
    },
  ...
  register('sf_button',sf_button);
  register('sf_navbar',sf_navbar);
  register('sf_textbox',sf_textbox);
  register('sf_login',sf_login);
  register('sf_about',sf_about);
  register('sf_signup',sf_signup);
  register('sf_home',sf_home);
  register('sf_title',sf_title);
  register('route',routeHoc);
  register('router',routerHoc);
  component(app)(document.getElementById('sf_app'));
